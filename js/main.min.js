...
streetName:g,ward:t,poll:v},"json").done(function(a){k.innerHTML="";0===a.length?q.innerHTML='<li class="list-group-item list-group-item-warning">No voting location found.</li>':(q.innerHTML="",a.forEach(function(a){var b=n+encodeURIComponent(a.Address1+", "+a.City+", "+a.Province+" "+a.PostalCode),b='<li class="list-group-item" role="listitem"><div class="row">'+('<p class="col-sm my-0" aria-label="Voting location date and time">'+a.DateOpenStringLocal+"<br />"+a.StartTime+" to "+a.EndTime+"</p>")+
('<p class="col-sm my-0" aria-label="Votting location address">'+(""===a.LocationName?"":a.LocationName+"<br />")+'<a href="'+b+'" title="Find this Location" target="_blank">'+a.Address1+"</a>"+(""===a.Address2?"":"<br />"+a.Address2)+"</p>")+"</div></li>";a.IsAdvancePoll?k.insertAdjacentHTML("beforeend",b):q.insertAdjacentHTML("beforeend",b)}));b=!0;u()});var p=document.getElementById("candidateList--listGroups");p.innerHTML='<p>Loading... <i class="fas fa-spinner fa-pulse"></i></p>';var r=function(a,
b){var c=b.CandidateName,e=b.CandidateName.split(",");2===e.length&&(c=e[1].trim()+" "+e[0]);return a+'<li class="list-group-item" role="listitem">'+c+"</li>"};$.get("voterView.asp",{method:"candidate_list",ward:t},"json").done(function(a){p.innerHTML=a.Positions.reduce(function(a,b,c){return a+'<h4 class="clearfix mt-2"><span class="float-left" id="candidateList--'+c+'_label">'+b.PositionName+'</span> <small class="float-right"><span class="badge badge-secondary">'+b.Candidates.length+" candidate"+
(1===b.Candidates.length?"":"s")+'</span> <span class="badge badge-secondary">'+b.NumberPositions+" position"+(1===b.NumberPositions?"":"s")+"</span></small></h4>"+('<ul class="list-group" role="list" aria-labelledby="candidateList--'+c+'_label">'+b.Candidates.reduce(r,"")+"</ul>")},"");e=!0;u()});w=!0;l.classList.remove("d-none");f.classList.add("d-none");c.setAttribute("aria-expanded","false");c.value=h;c.setCustomValidity("");m=h.toLowerCase();d=f.getElementsByTagName("button");for(g=0;g<d.length;g+=
1)d[g].getAttribute("data-address")!==h&&(d[g].outerHTML="",--g);a.setAttribute("aria-selected","true");c.setAttribute("aria-activedescendant",a.id)}function z(a){var b=a.currentTarget;switch(a.key){case "ArrowDown":b.setAttribute("aria-selected","false");(a=b.nextElementSibling)?a.focus():(c.focus(),a=f.getElementsByTagName("button")[0]);a.setAttribute("aria-selected","true");c.setAttribute("aria-activedescendant",a.id);break;case "ArrowUp":b.setAttribute("aria-selected","false"),(a=b.previousElementSibling)?
(a.focus(),a.setAttribute("aria-selected","true"),c.setAttribute("aria-activedescendant",a.id)):c.focus()}}function k(){var a=c.value.trim().toLowerCase();c.removeAttribute("aria-activedescendant");if(""===a)m=a,f.innerHTML='<div class="list-group-item list-group-item-info" role="alert">To get started, enter your address.<br /><em>i.e. 99 Foster Dr</em></div>';else if(m!==a)if(n&&0===a.indexOf(m))f.innerHTML='<div class="list-group-item list-group-item-danger" role="alert"><strong>There are no addresses available.</strong><br />Be sure to use a complete residential address with the civic number first.</div>';
