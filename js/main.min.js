$(document).ready(function(){function l(a){a.preventDefault();h.classList.add("d-none");var b=a.currentTarget;a=b.getAttribute("data-address");var g=b.getAttribute("data-street-number"),c=b.getAttribute("data-street-name"),m=b.getAttribute("data-ward"),b=b.getAttribute("data-poll");document.getElementById("addressDetails--address").innerText=a;document.getElementById("addressDetails--ward").innerText=m;document.getElementById("addressDetails--poll").innerText=b;var k=document.getElementById("votingLocations--electionDay");
