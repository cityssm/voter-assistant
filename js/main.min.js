...
b.Address+'" data-street-number="'+b.StreetNumber+'" data-street-name="'+b.StreetName+'" data-street-name-full="'+d+'" data-ward="'+b.Ward+'" data-poll="'+b.PollAndSuffix+'" role="option" type="button" aria-posinset="'+f+'" aria-selected="false"><div class="clearfix"><strong class="float-left">'+b.Address+"</strong>"+('<small class="float-right text-right">Ward '+b.Ward+"<br />Poll "+b.PollAndSuffix+"</small>")+"</div></button>"},"");if(m){a=e.getElementsByTagName("button");var d;for(d=0;d<a.length;d+=
